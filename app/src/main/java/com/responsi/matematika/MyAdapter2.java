...
public class MyAdapter2 extends RecyclerView.Adapter<MyViewHolder> {
    ...
    public MyAdapter2(LihatMateri lihatMateri, ArrayList<DownModel> downModels) {
        this.lihatMateri = lihatMateri;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        LayoutInflater layoutInflater = LayoutInflater.from(lihatMateri.getBaseContext());
        View view2 = layoutInflater.inflate(R.layout.elements, null, false);
