...
public class AdminLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMasuk1 = findViewById(R.id.btnMasuk1);
        ...
        btnMasuk1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                reference = FirebaseDatabase.getInstance().getReference().child("Admin").child(username);
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            if (password.equals(passwordFromFirebase)) {
                                ...
                                editor.putString(username_key, etUsername1.getText().toString());
                                editor.apply();

                                //berpindah ke home
                                Intent keHome = new Intent(AdminLogin.this, AdminDashboard.class);
